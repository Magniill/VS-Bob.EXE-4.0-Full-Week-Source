...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'magniill':
				// hey magniilll is here!
				tex = Paths.getSparrowAtlas('characters/Magniill');
				frames = tex;
				animation.addByPrefix('idle', 'magniill idle', 24, false);
				animation.addByPrefix('singUP', 'magniill up', 24, false);
				animation.addByPrefix('singRIGHT', 'magniill right', 24, false);
				animation.addByPrefix('singDOWN', 'magniill down', 24, false);
				animation.addByPrefix('singLEFT', 'magniill left', 24, false);
